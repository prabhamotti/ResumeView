...
2.Add sub protocol command assembly definition of "SuperWebSocket.Samples.CommandAssembly" to the websocket server instance's configuration element of SuperWebSocket's running container,
